...
export class ResultContentModelFactory extends BaseModelFactory {
    ...
    public retrieve() {
        ...
        if (isNullOrUndefined(this.resultFile)) {
            return new ResultContentModel(this._dao);
        }
        ...
        switch (format) {
            case "txt":
                ...
                break;
            case "tsv":
                return new ResultContentTSVModel(this._dao);
                break;
            case "csv":
                return new ResultContentCSVModel(this._dao);
                break;
            case "json":
                // TODO implement in the futrue
                return new ResultContentJSONModel(this._dao);
            default:
                return new ResultContentModel(this._dao);
                break;
        }
